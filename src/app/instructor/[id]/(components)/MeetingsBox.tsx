...
export default function MeetingsBox({
	...
	return (
		<div className='space-y-4'>
			{(upcomingCalls.length === 0)?(<p className='text-xs  opacity-60'>No upcoming meetings</p>):null}
			<p className='text-xs  opacity-60'>No. of ongoing calls {ongoingCalls.length}</p>
